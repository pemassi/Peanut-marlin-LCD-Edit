...
#define STRING_CONFIG_H_AUTHOR "(lcd, Peanut)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {78.88, 79, 160*16, 143.4624}  // default steps per unit for Ultimaker
